...
<div class="container p-0 conteiner-detail-training">
    <div class="row">
        <div class="col-lg-5 col-md-5 p-0" style="position: relative;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="py-3 px-4 w-100 d-flex btn-share-group">
                    ...
                    @endphp
                    <button id="btn_like_item" class="btn btn-like {{ $check_like }} me-1" onclick="action_btnlike_dislike(this.className);return create_logs('Like Training _{{ $training->title }}');">
                    ...
                    <button id="btn_dislike_item" class="btn btn-dislike {{ $check_dislike }} me-1"   onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Training _{{ $training->title }}');">
                        <div class="icon-btn">
                            <i class="fa-solid fa-thumbs-down"></i>
                        </div>
                    </button>
                    <button class="btn btn-share me-1"  onclick="click_share_training();return create_logs('Share Training _{{ $training->title }}');">
                ...
                <div class="{{ $check_fav }} px-2 py-0 d-flex align-items-start btn-bookmark-training cursor-pointer" onclick="action_btnlike_dislike(this.className);return create_logs('Fav Training_{{ $training->title }}');">
        ...
        <div class="col-lg-7 col-md-7 px-4 mb-5">
                ...
                @if( !empty($training->link_out) )
                <!-- if ถ้ามีลิงค์เข้าร่วมสอบ -->
                    <a href="{{ $training->link_out }}" target="bank" class="btn w-100 btn-join-meet my-2 mt-4" onclick="return create_logs('Join Training schedule_{{ $training->title }}');">
            ...
            <div class="detail-training">
                ...
                <div class="w-100 mt-4">
                    ...
                    <div class="d-flex justify-content-end ">
                        <button class="btn btn-like {{ $check_like }}  me-1" onclick="action_btnlike_dislike(this.className);return create_logs('Like Training _{{ $training->title }}');">
                            <div class="icon-btn d-flex">
                                <i class="fa-solid fa-thumbs-up"></i>
                            </div>
                        ...
                        <button class="btn btn-dislike {{ $check_dislike }} me-1" onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Training _{{ $training->title }}');">
                            <div class="icon-btn">
                                <i class="fa-solid fa-thumbs-down"></i>
                            </div>
                        </button>
