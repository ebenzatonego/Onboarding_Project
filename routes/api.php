...
Route::get('/get_user_for_log/{user_id}', 'AdminController@get_user_for_log');
...
Route::get('/get_list_log_web_delete', 'LogsController@get_list_log_web_delete');
...
Route::get('/get_log_content/{type}', 'LogsController@get_log_content');
