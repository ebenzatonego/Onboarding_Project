<div class="form-group {{ $errors->has('name_type') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="name_type" type="text" id="name_type" value="{{ isset($news_type->name_type) ? $news_type->name_type : ''}}" >
...
<div class="form-group {{ $errors->has('number_menu') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="number_menu" type="text" id="number_menu" value="{{ isset($news_type->number_menu) ? $news_type->number_menu : ''}}" >
...
<div class="form-group {{ $errors->has('check_highlight') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="check_highlight" type="text" id="check_highlight" value="{{ isset($news_type->check_highlight) ? $news_type->check_highlight : ''}}" >
