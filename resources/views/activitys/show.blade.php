        ...
        <div class="col-lg-5 col-md-5 p-0" style="position: relative;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="py-3 px-4 w-100 d-flex btn-share-group">
                    ...
                    @endphp
                    <button id="btn_like_item" class="btn btn-like {{ $check_like }} me-1"  onclick="action_btnlike_dislike(this.className);;return create_logs('Like ตารางกิจกรรม_{{ $activity->title }}');">
                    ...
                    <button id="btn_dislike_item" class="btn btn-dislike {{ $check_dislike }} me-1"   onclick="action_btnlike_dislike(this.className);;return create_logs('Dislike ตารางกิจกรรม_{{ $activity->title }}');">
                        <div class="icon-btn">
                            <i class="fa-solid fa-thumbs-down"></i>
                        </div>
                    </button>
                    <button class="btn btn-share me-1"  onclick="click_share_activity();return create_logs('Share ตารางกิจกรรม_{{ $activity->title }}');">
                ...
                <div class="{{ $check_fav }} px-2 py-0 d-flex align-items-start btn-bookmark-training cursor-pointer" onclick="action_btnlike_dislike(this.className);return create_logs('Fav ตารางกิจกรรม_{{ $activity->title }}');">
            ...
            <div class="px-4 title-training">
                ...
                <div id="div_show_rating" class="rating-training mt-2">
                    <span id="sum_rating_span" style="color: #EDB529;font-size: 14px;font-style: normal;font-weight: 600;line-height: normal;margin-right: 5px;">
                        {{ number_format($activity->sum_rating, 1) }}
                    </span>
                    <i id="sum_rating_i" data-star="{{ number_format($activity->sum_rating, 1) }}" class="star-rating"></i>
                </div>
                @else
            ...
            <div class="detail-training">
                ...
                <div class="w-100 mt-4">
                    ...
                    <div class="d-flex justify-content-end ">
                        <button class="btn btn-like {{ $check_like }}  me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Like ตารางกิจกรรม_{{ $activity->title }}');">
                            <div class="icon-btn d-flex">
                                <i class="fa-solid fa-thumbs-up"></i>
                            </div>
                        ...
                        <button class="btn btn-dislike {{ $check_dislike }} me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Dislike ตารางกิจกรรม_{{ $activity->title }}');">
                            <div class="icon-btn">
                                <i class="fa-solid fa-thumbs-down"></i>
                            </div>
                        </button>
...
<div class="modal fade" id="rating" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-vote-training">
            <p class="text-white text-center mb-5 font-20">ให้คะแนนกิจกรรมนี้</p>
...
<div class="modal fade" id="dislike_training" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-vote-training">
            <p class="text-white text-center mb-5 font-20">ให้เหตุผลที่ไม่ชอบกิจกรรมนี้</p>
            <div class="w-100 d-flex justify-content-center px-4 mb-2">
                <textarea class="form-control" id="reasons_dislike" placeholder="กรอกเหตุผลที่ไม่ชอบกิจกรรมนี้" rows="5" style="border-radius: 10px;" oninput="check_reasons_dislike()"></textarea>
            </div>
