    ...
    <div class="main-body">
        <div class="row">
            <div class="mt-2 d-flex flex-wrap w-100 d-flex justify-content-center">
                ...
                <a class="btn-product disabled" href="" type="button" onclick="return create_logs('สุขภาพทางการเงิน_button');">
                    สุขภาพทางการเงิน
                ...
                <a class="btn-product " href="{{ url('/page_products') }}" onclick="return create_logs('ผลิตภัณฑ์_button');">ผลิตภัณฑ์</a>
                <a class="btn-product active" href="{{ url('/page_products_fav') }}" onclick="return create_logs('ผลิตภัณฑ์โปรด_button');">ผลิตภัณฑ์โปรด</a>
            </div>
