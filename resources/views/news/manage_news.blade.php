...
<script>
              ...
              if(result){
                ...
                for (let i = 0; i < result.length; i++) {
                  ...
                  for (let ix = 0; ix < 3; ix++) {
                    ...
                    list_number = `
                      <li>
                        <span class="dropdown-item btn" onclick="change_number_menu_of_news('`+result[i].id+`' , '`+count+`')">
                          ลำดับที่ `+count+`
                        </span>
                      </li>
                    `;
                  ...
                  if(result[i].number_menu_of_news){
                    html_number_menu = `
                      <i class="fa-solid fa-circle-`+result[i].number_menu_of_news+` font-24 text-info"></i>
                    `;
                  }
  ...
  function change_number_menu_of_news(type_id , number){

    fetch("{{ url('/') }}/api/change_number_menu_of_news/"+ type_id + "/" + number)
