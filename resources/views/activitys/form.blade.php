...
<script>
    ...
    function check_data_for_submit(){
        ...
        if(check_all_day.checked){
          ...
          if (title && activity_type_id && date_start && text_in_location_detail && link_map && select_photo && datetime_start) {
          ...
          if (title && activity_type_id && date_start && time_start && date_end && time_end && text_in_location_detail && link_map && select_photo && datetime_start) {
              btn_submit.classList.remove('disabled');
          }
          else{
              btn_submit.classList.add('disabled');
