    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 p-0" style="position: relative;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="py-3 px-4 w-100 d-flex btn-share-group">
                    ...
                    @endphp
                    <button id="btn_like_item" class="btn btn-like {{ $check_like }} me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Like Test_{{ $appointment->title }}');">
                    ...
                    <button id="btn_dislike_item" class="btn btn-dislike {{ $check_dislike }} me-1"   onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Test_{{ $appointment->title }}');">
                        <div class="icon-btn">
                            <i class="fa-solid fa-thumbs-down"></i>
                        </div>
                    </button>
                    <button class="btn btn-share me-1"  onclick="click_share_training();return create_logs('Share Test_{{ $appointment->title }}');">
                ...
                <div class="{{ $check_fav }} px-2 py-0 d-flex align-items-start btn-bookmark-training cursor-pointer" onclick="action_btnlike_dislike(this.className);return create_logs('Fav Test_{{ $appointment->title }}');">
        ...
        <div class="col-lg-7 col-md-7 px-4 mb-5">
            ...
            <!-- if ถ้ามีลิงค์เข้าร่วมสอบ -->
                <a href="{{ $appointment->link_out }}" target="bank" class="btn w-100 btn-join-meet my-2" onclick="return create_logs('Join Test schedule_{{ $appointment->title }}') ;">
            ...
            <div class="detail-training">
                ...
                <div class="w-100 mt-4">
                    ...
                    <div class="d-flex justify-content-end ">
                        <button class="btn btn-like {{ $check_like }}  me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Like Test_{{ $appointment->title }}');">
                            <div class="icon-btn d-flex">
                                <i class="fa-solid fa-thumbs-up"></i>
                            </div>
                        ...
                        <button class="btn btn-dislike {{ $check_dislike }} me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Test_{{ $appointment->title }}');">
                            <div class="icon-btn">
                                <i class="fa-solid fa-thumbs-down"></i>
                            </div>
                        </button>
...
<script>
    ...
    function click_share_training(){
        ...
        btn_for_copy_Share.setAttribute('onclick' , "copy_Share_social_media();save_log_share('appointments' , 'copy' , '"+appointment_id+"')");
