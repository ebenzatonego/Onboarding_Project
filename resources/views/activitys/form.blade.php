        ...
        <div class="card border-top border-0 border-4 border-info">
            <div class="card-body">
                <div class="p-4 rounded">
                    ...
                    <div class="row mb-3">
                        <label for="photo_gallery" class="col-sm-2 col-form-label">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div id="div_not_show_all_member" class="mt-3 row d-none">
                                ...
                                <div id="div_show_for_account" class="col-12 mt-3">
                                  ...
                                  <textarea class="form-control mt-3" rows="5" type="textarea" name="show_individual" id="show_individual" placeholder="เพิ่ม Account [เพิ่มหลาย Account คั่นด้วยเครื่องหมาย , (จุลภาค)]" onchange="check_data_for_submit();"></textarea>
                                </div>
    ...
    function check_data_for_submit(){
        ...
        if(check_all_day.checked){
          if (title && activity_type_id && location_detail && date_start && link_map && select_photo && datetime_start) {
              if(show_all_member != 'Yes'){
                if(show_individual || show_rank){
