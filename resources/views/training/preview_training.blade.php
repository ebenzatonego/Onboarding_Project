        ...
        <div class="card border-top border-0 border-4 border-primary ms-4 w-100">
            <div class="card-body p-5">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="link_out" type="text" id="link_out" value="{{ isset($data_training->link_out) ? $data_training->link_out : ''}}" placeholder="เพิ่มลิงก์ LMS" onchange="show_preview_data('link_out',event);show_preview_date_start_end();">
                    </div>
                </div>
                <div class="row mb-3">
