...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Tools_contacts</div>
                    <div class="card-body">
                        <a href="{{ url('/tools_contacts/create') }}" class="btn btn-success btn-sm" title="Add New Tools_contact">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/tools_contacts') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
