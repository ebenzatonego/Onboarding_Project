...
<div class="calender-container container">
    <div class="header-calendar ">
        <div class="w-100 d-flex justify-content-between">
            ...
            <button class="btn-add-schedule" onclick="document.querySelector('.fc-customButton-button').click();">
                + Add Schedule
            </button>
        </div>
        ...
        <div class="modal-content" style="border-radius: 8.214px;position: relative;">
            ...
            <form id="myForm">
                <div class="modal-body px-5 pb-0">
                    ...
                    <div class="row mb-3">
                        <label for="start-date" class="col-3 col-form-label">ชื่อโน็ต</label>
                        <div class="col-9">
                            <input style="border-radius: 50px;" type="text" class="form-control" id="event-title" placeholder="กรอกชื่อโน็ต" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <textarea style="border-radius: 50px;color: #6E7781;border-radius: 8.214px;background: #E9EEFF;" class="form-control" id="detail_note" placeholder="กรอกเนื้อหาโน๊ต" rows="5"></textarea>
                    </div>
                    <div class="row mb-3">
                        <label for="start-date" class="col-3 col-form-label">วันที่เริ่ม</label>
                        <div class="col-9">
                            <input type="date" style="border-radius: 50px;" class="form-control" id="start-date" placeholder="เลือกวันที่เริ่ม" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="start-date" class="col-3 col-form-label">เวลาที่เริ่ม</label>
                        <div class="col-9">
                            <input type="time" style="border-radius: 50px;" class="form-control" id="time-start-date" placeholder="เลือกวันที่เริ่ม">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="end-date" class="col-3 col-form-label">วันที่จบ</label>
                        <div class="col-9">
                            <input type="date" style="border-radius: 50px;" class="form-control" id="end-date" placeholder="เลือกวันที่จบ">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="end-date" class="col-3 col-form-label">เวลาที่จบ</label>
                        <div class="col-9">
                            <input type="time" style="border-radius: 50px;" class="form-control" id="time-end-date" placeholder="เลือกวันที่เริ่ม">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="end-date" class="col-3 col-form-label">เลือกทั้งวัน</label>
                        <div class="col-9">
                            <input class="form-check-input" style="border-radius: 50%;width: 24px;height: 24px;" type="checkbox" id="gridCheck4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <select class="form-select mb-3" id="event-color" style="border-radius: 50px;" aria-label="Default select example" required>
                                <option selected="">เลือกหมวดหมู่</option>
                                <option value="#E54141" style="color: #E54141;">นัดลูกค้า</option>
                                <option value="#78CBE5" style="color: #78CBE5;">อบรม</option>
                                <option value="#FFBF44" style="color: #FFBF44;">สอบ</option>
                                <option value="#BD91FF" style="color: #BD91FF;">กิจกรรมบริษัท</option>
                                <option value="#8FC14E" style="color: #8FC14E;">ส่วนตัว</option>
                            </select>
