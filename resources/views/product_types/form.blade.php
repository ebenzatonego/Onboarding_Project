<div class="form-group {{ $errors->has('name_type') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="name_type" type="text" id="name_type" value="{{ isset($product_type->name_type) ? $product_type->name_type : ''}}" >
...
<div class="form-group {{ $errors->has('number_menu') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="number_menu" type="text" id="number_menu" value="{{ isset($product_type->number_menu) ? $product_type->number_menu : ''}}" >
...
<div class="form-group {{ $errors->has('check_highlight') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="check_highlight" type="text" id="check_highlight" value="{{ isset($product_type->check_highlight) ? $product_type->check_highlight : ''}}" >
