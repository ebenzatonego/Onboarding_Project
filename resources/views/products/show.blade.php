    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 p-0" style="position: relative;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="py-3 px-4 w-100 d-flex btn-share-group">
                    ...
                    @endphp
                    <button id="btn_like_item" class="btn btn-like {{ $check_like }} me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Like Product _{{ $product->title }}');">
                    ...
                    <button id="btn_dislike_item" class="btn btn-dislike {{ $check_dislike }} me-1"   onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Product _{{ $product->title }}');">
                        <div class="icon-btn">
                            <i class="fa-solid fa-thumbs-down"></i>
                        </div>
                    </button>
                    <button class="btn btn-share me-1"  onclick="click_share_training();return create_logs('Share Product _{{ $product->title }}');">
                ...
                <div class="{{ $check_fav }} px-2 py-0 d-flex align-items-start btn-bookmark-training cursor-pointer" onclick="action_btnlike_dislike(this.className);return create_logs('Fav Product _{{ $product->title }}');">
            ...
            <div class="px-4 title-training">
                ...
                <div id="div_show_rating" class="rating-training mt-2">
                    <span id="sum_rating_span" style="color: #EDB529;font-size: 14px;font-style: normal;font-weight: 600;line-height: normal;margin-right: 5px;">
                        {{ number_format($product->sum_rating, 1) }}
                    </span>
                    <i id="sum_rating_i" data-star="{{ number_format($product->sum_rating, 1) }}" class="star-rating"></i>
                </div>
                @else
        ...
        <div class="col-lg-7 col-md-7 px-4 mb-5">
            ...
            <div class="detail-training">
                ...
                <button class="btn w-100 btn-download-pdf my-5" onclick="user_click_pdf_btn();return create_logs('Download Product_{{ $product->title }}');">
                ...
                <div class="w-100 mt-4">
                    ...
                    <div class="d-flex justify-content-end ">
                        <button class="btn btn-like {{ $check_like }}  me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Like Product _{{ $product->title }}');">
                            <div class="icon-btn d-flex">
                                <i class="fa-solid fa-thumbs-up"></i>
                            </div>
                        ...
                        <button class="btn btn-dislike {{ $check_dislike }} me-1"  onclick="action_btnlike_dislike(this.className);return create_logs('Dislike Product _{{ $product->title }}');">
                            <div class="icon-btn">
                                <i class="fa-solid fa-thumbs-down"></i>
                            </div>
                        </button>
